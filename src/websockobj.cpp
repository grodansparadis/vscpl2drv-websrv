// websockobj.cpp: implementation of the CWS1 class.
//
...
bool
CWS1::open(std::string& path, const cguid& guid)
{
    // Set GUID
    m_guid = guid;
...
// bool
// CWS1::parseHLO(uint16_t size, uint8_t* inbuf, CHLO* phlo)
// {
//     // Check pointers
//     if (NULL == inbuf) {
//         syslog(
...
// bool
// CWS1::handleHLO(vscpEvent* pEvent)
// {
...
bool
CWS1::eventExToReceiveQueue(vscpEventEx& ex)
{
...
bool
CWS1::addEvent2SendQueue(const vscpEvent* pEvent)
{
